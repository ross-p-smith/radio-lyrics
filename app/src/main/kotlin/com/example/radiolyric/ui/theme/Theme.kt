...
/**
 * In-car Material 3 theme. Defaults to a dark, high-contrast palette because
 * head-unit screens are usually dark-mode by default. A future
 * `SettingsRepository` can override the [forceDark] flag.
 */
@Composable
fun RadioLyricTheme(
